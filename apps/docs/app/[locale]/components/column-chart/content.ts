...
const en: ColumnChartPageContent = {
  ...
  examples: {
    ...
    cards: {
      basic: { title: 'Basic', subtitle: 'number[] + labels + trend + source' },
      ...
      perBarEmphasis: { title: 'Per-bar emphasis', subtitle: 'highlight + note on the SUN bar' },
...
const ru: ColumnChartPageContent = {
  ...
  examples: {
    ...
    cards: {
      basic: { title: 'Базовый', subtitle: 'number[] + labels + trend + source' },
      ...
      perBarEmphasis: { title: 'Акцент на столбце', subtitle: 'highlight + note на столбце ВС' },
